...
function BlogPostDetails() {
  const {id} = useParams()
  async function fetchSpecificNewsFromDB() {
    const URL = `https://newsapi.org/v2/everything?id=0&apiKey=a08f2a51199e446db23bdbfd57b9f2e0`;
    try {
  ...
  return (
    <main className="mt-10">
      ...
      <div className="px-4 lg:px-0 mt-12 text-white max-w-screen-md mx-auto text-lg leading-relaxed">
        ...
        <h2 className="text-2xl text-white font-semibold mb-4 mt-4">
